...
public class setProfile extends AppCompatActivity {
    ...
    private void sendDataToRealTimeDatabase() {
        ...
        databaseReference.setValue(muserprofile).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), "Failed to add profile to Realtime Database", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(getApplicationContext(), "Image URI fetched successfully", Toast.LENGTH_SHORT).show();
                        sendDataTocloudFirestore();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(getApplicationContext(), "Failed to fetch Image URI", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void sendDataTocloudFirestore() {
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), "Failed to send data to Firestore", Toast.LENGTH_SHORT).show();
                mprogressbarofsetprofile.setVisibility(View.INVISIBLE);
            }
        });
    }
